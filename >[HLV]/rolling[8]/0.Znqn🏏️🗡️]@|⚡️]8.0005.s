...
#jmp ram_drop_thru_2   #emergency skip all
 ...
 #is not actually finished u need 2 check _@*1
   
 #  pre_all_2: # need 2 check of -1 AND both are ** 
   #u may actually need 2 do after, tho f0r __*_ 
   #i think canceling them both at start is fine
   #otherwise u would want them 2 drop down and be used
   #like 0's 1's (logic doesn't drop down either , its not supposed 2 , thats like, defying gravity just2 be cute, 
#   this isn't candy crush... ofc u can go back and do that
  # later if u want...🍬️🍫️KISS m8...🍫️
  #nothing is supposed to be on your "RAM" cept for "binary"
  #🐟️🥚️🥚️🥚️ o<...
#now u may do that if u need 2 do wires, but lets try this first.
#that way we have a full working version either way 2 test with <3
 
 #sum: u may do "arg/yr"drop on Logic_3 
 #because we may do them on the "1ram" cuz it may actually be
 #easier, but dont beat urself up if we do cuz we didn't no ie:w8
 #🐟️🥚️🥚️🥚️o<...
 ...
 cmp_my_a_2:
  ...
  #🖍️it should return "empty ram > ...." if -1"_" cuz ... thats what it did b4
  #🖍️ (literally forgot $ before "_" UGH
    cmp $-1 , %r10
  jne cmp_my_b_2
  cmp $'_' , %rbx
  je midding_2
...
check_if_less_a: #📍️ do this after, when we get "SOMETHING DROPPING"
#🔊️#🔊️
cmp_ab:
cmp_a: 
cmp $'_', %rax
...
#✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️
   mov %r10 , %r11
   #WORKING SO FAR apr18 4:20 <3 (go 2 bed qt <3)

sub $1  , %r11  #subtracting will replace 
