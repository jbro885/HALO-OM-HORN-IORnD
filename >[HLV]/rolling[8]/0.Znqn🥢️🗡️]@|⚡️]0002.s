...
#🪱️ WIRE HEADER ? (should be pre everything else it seems
		#may put wires in seperate ram and count how many "children" they have 4 pure binary output
		#also 4 now just assume they only have 1 "child" unless they need more
		#also the wires and children shoudl synch up by abc # so dont go out of abc order...
wire_header_ab_2:
...
wire_to_target_ab_2 :  #this is where any headers can get wired
...
post_logic_check_ab_2:  #this is the "magic spot" it was messd up b4
		#u can still get the same fx tho, if u skip "_" down here
		#this is where u want it skipped so u can do ur stuff
		#up top ,and keep the majority of the spx. ur good 
		#keep pushign
