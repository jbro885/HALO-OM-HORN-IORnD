...
wire_cmp_a_2:
    ...
    cmp  $'g', %rax     #as if 4 regs (or less m8)
    jg    wire_cmp_b_2
   ...
   mov $'_' , %rax
    ...
    cmp  $'g', %rbx     #as if 4 regs (or less m8)
...
#✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️✂️
#🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️🍶️
#APR27 =isn't moving into wRam yet, lets fix this...(header code is null...)
#its dropping 2 "bRam" which it should NEVER do  , may fix all...
start_post_compare_2:
...
#u may wanna check r11 > -1 
cmp $-1 , %r11
je end_scoop_wr_d_2
##################

dec %r11  #cause u removed from stack
 mov (%r13,%r11,1) , %rdx  #move from bRam to rdx 2 wRam
movq $'.' , (%r13,%r11,1) 
...
end_scoop_wr_d_2:
#🪱️##🪱️##🪱️#
 mov $'_' , %rdx  # delete rdx, its done regardless
end_post_compare_2:
