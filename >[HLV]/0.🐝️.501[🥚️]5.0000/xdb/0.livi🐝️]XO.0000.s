...
mov a_sum(%rbp)  ,  %rax  # wasinstruction   #🗡️ input _ a 
mov b_sum(%rbp) , %rbx #output##🗡️ input _ b 
...
#✂️✂️✂️✂️✂️✂️#🪱️
   ...
   #  jmp  start_test_a2b_1  #make sure ur regs are clear.
     #also dont clear %r11. ever
