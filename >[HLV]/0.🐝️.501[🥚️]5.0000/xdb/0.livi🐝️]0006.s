...
call ascii_newline
call ascii_newline
#call buffer_to_ram_126
#call buffer_to_ram_256
...
#_________________________
 ...
 ###########
  ...
  mov $BUFFER_DATA, %r11  #✅️do not change this! 
  movq $ascii_sing, %r12 #❌️temp , dont need 
 mov $0,%r13   #❌️ counts up till abcd_ (then clear till next loop
...
# movb test_sum_2_2(%rbp) , %bl #❎️
#call exit  	


#is cutting off last digit
######################
 	 store_result_1: 
...
end_store_result_1:
 	...
 	#mov %al ,(%r10,%r13,1)  #goes in backwards! (its ok debug)
 	inc %r13   #loop 4 4 fill, can reuse when 4 is full
 	cmp $4 , %r13 #4 is 2 much
 	jne  start_reverse_ascii_in_only_1
