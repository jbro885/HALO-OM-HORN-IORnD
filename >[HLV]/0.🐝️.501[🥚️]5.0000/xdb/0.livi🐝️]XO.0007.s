...
match_head_tail_d_2_vi:	
	...
	cmp  $'_', %dl
	je    end_scoop_wr_d_2_vi
	cmp  $':', %dl     #thinking of swapping for 00001010
			#since 0010 1111 (may look like a "WRM"
			#were just doing it 4 >qlu 
			#will keep 0010 1111 2 avoid confusion
			#and see if the swap takes. try w/e
	je    end_scoop_wr_d_2_vi
	cmp  $'A', %dl
