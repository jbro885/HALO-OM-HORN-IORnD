...
if(nTestX < 0 || nTestX >= nMapWitch || nTestY < 0 ||
nTestY >= nMapHeight){
...
int nCeling = (float)(nScreenHeight / 2.0 ) - nScreenHeight / ((float)fDistanceToWall);
...
for (int y = 0 ; y < nScreenHeight ; y++){
	...
	screen[y*nScreenWidth + x] = '"\033[38;2;255;0;0;48;2;0;255;0m\U00002580\033[0m"'; //floor
