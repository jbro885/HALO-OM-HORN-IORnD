...
int stdBufferSize_H = 4096000; ///409600000 ;
 
 int stdBlockSize_H = 4096 ; 
...
// int stdKbdInOffset_H = 160 ; //*was 126accidently?  //size is 32
 ...
 int stdBinCryOffset_H = 128 ; // ITS A STACK !🤯️
  ...
  int stdKbdCountOffset_H = 256; // 128+64
 
  int stdKbdAscii_H = 16 ;
 
 // int stdKbdInOffset_H = 160 ; //*was 126accidently?  //size is 32
 int stdKbdBufferOffset_H = 192 ;
////
...
int converttobinaryMalloc(int n, char *op, int mallocSize){
