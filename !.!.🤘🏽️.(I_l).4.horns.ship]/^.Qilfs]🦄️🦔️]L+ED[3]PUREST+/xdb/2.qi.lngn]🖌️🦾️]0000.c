...
// 🔍️qlu zhin sol🀄️
//👩🏻‍🚀️just put "inode info ANYWHERE" we can always move it. just code!👩🏻‍🚀️
//🔍️
//❤️‍🔥️there should be no more "]PURE" drops cuz 
//❤️‍🔥️u have enough info 2 code now !
					//dont need more math <3 
...
global_inode_ct = stdIncInodeAddBloc();// + 1 ; Std_inc_inode_count_H(); < trying this instead
...
///
   write2Position_0000(fullSum ,stdBlockBuffer_1,stdAsciiBuffer_1,stdKbdAsciiSize_H); 
  //
...
snprintf(buffer, max_len,"inode_ct = %d", global_inode_ct);
//sprintf("inode_ct = %d", global_inode_ct);
...
Std_inc_inode_count_H(std_superBLockFilename_H); //📆️3.25.24 <was missing
strcpy(filename3, local_proDirString_0); // 🧠️📁️/📄️
//exit(9);
