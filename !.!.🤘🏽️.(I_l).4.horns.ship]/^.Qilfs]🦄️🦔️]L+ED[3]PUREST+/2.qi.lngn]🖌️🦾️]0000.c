...
//global_inode_ct = stdIncInodeAddBloc();// + 1 ;

global_inode_ct = stdIncInodeAddBloc_H(filename3) + 1 ;
...
snprintf(buffer, max_len,"%s = %d", filename3,  global_inode_ct);
//sprintf("inode_ct = %d", global_inode_ct);
