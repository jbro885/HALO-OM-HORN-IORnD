...
//🏴️🏴️🏴️🏴️🏴️🏴️🏴️
void Std_inc_inode_count_H(char *superBLock_filename_H_1){
...
//strcpy(local_InodenameString_0, Std_ProFileDir);
//strcat(local_InodenameString_0, local_BlockCountBinary);
//strcat(local_InodenameString_0, Std_ProFileTag);
...
Std_createDirProStringFromBin(local_NewBlockString,returnProDirString_R);       //📌️
//Std_FullBlockString  // <return this, pass it in first ofc.
}
//🧠️🧠️🧠️®️®️®️🧠️🧠️🧠️®️®️®️🧠️🧠️🧠️®️®️®️
//🦾️
