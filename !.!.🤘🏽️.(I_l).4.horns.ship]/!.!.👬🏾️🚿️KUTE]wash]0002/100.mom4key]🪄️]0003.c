...
char command1[50];
  ...
  // strcpy( command1, "./1.write.down.fd+arg]🦄️" );
   ...
   system("./1.kbd2.mem]⌨️🎫️]0002.+x 0000000000110000.pro" );
...
//char command1[50];
  ...
  // strcpy( command1, "./1.write.down.fd+arg]🦄️" );
   ...
   system("./2.qil.ngn]🪶️🎨️]0002.+x 0000000000110000.pro 0000000000110001.pro 0000000000110010.pro 0000000000110011.pro 0000000000110100.pro 0000000000110101.pro");
...
//char command1[50];
  ...
  // strcpy( command1, "./1.write.down.fd+arg]🦄️" );
   ...
   //  system("./^.fd28bit-log+cliop🪄️⌨️])
   //system("./1.write-up-fd+arg]🦄️" );
   system("./3.rDR]Qil]🎬️🎞️📽️🖥️]0001.+x 0000000000110000.pro 0000000000110001.pro 0000000000110010.pro 0000000000110011.pro 0000000000110100.pro 0000000000110101.pro");
...
//      printf("\n ERROR: return code from pthread_create is %d \n", rc);
 ...
 //   printf("\n Created new thread (%u)... \n", thread_id);
         ...
         rc3 = pthread_create(&thread_id3, NULL, Three, (void*)t);
    if(rc)
    {
   //   printf("\n ERROR: return code from pthread_create is %d \n", rc);
      exit(1);
