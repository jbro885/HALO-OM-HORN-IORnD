...
jz null_situation
# jmp preadd_invisible
 
 
 
 cmp $15,  %rdx
 jge preadd_invisible
 
 #probably wanna premptively subtract this from wiring count 2 save wires <3 
 
   # mov command_hx(%rbp), %rax 
   # dec %rax  #🔑️
   # movq %rax , command_hx(%rbp) #🔑️
    
    #u should have already skipped this if "command_hx or w/e is zero (oops 
    #and for some reason its minus-ing even tho "0-0" should be completely skipping cuz should be zerol.
    
#cut this off and look at "ONLY ZERO FIRST" 
