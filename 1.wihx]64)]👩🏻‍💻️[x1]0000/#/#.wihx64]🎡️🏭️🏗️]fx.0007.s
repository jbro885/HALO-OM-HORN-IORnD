...
#🧧️
#👖️> change? were gonna save add (and just add negative if necessary)
#👖️ -1+-1=-2 ;) (add at each end. 
...
movq command_a(%rbp), %rax
movq command_b(%rbp), %rbx
...
#🏴‍☠️️can use shregs only for all math etc in dfpga ;) do this 4 now pre mba 
    add_posneg_chunk: 
...
end_base_math:
  #⚾️⚾️⚾️⚾️⚾️⚾️⚾️⚾️⚾️⚾️
  #✒️
   dec %rdx  #or be ahead 1 , u pic tbh 
    #✒️
#🥟️🥟️🥟️(will remove entirely? no its doing inc)
...
#🔻️
 ...
 #  call exit 
    ...
    #🖨️[print test RIGHT NOW , before adding (as usual;)]
